...
TEST_CASE("Dense AbsentBQR", "[dense][AbsentBQR]") {
    ...
    SECTION("AbsentBQR " + benchmarkName) {
        ...
        Node q{empty(holder), empty(holder), NodeType::PROPOSITION, 0, 0, 0, 0};      
        Node p{empty(holder), empty(holder), NodeType::PROPOSITION, 0, 0, 0, 0};      
        Node r{empty(holder), empty(holder), NodeType::PROPOSITION, 0, 0, 0, 0};      
        Node not_q{empty(holder), empty(holder), NodeType::NOT, 0, 0, 0, 0};          
        Node once_q{empty(holder), empty(holder), NodeType::EVENTUALLY, 0, 0, 0, B_INFINITY}; 
        Node and1{empty(holder), empty(holder), NodeType::AND, 2, 3, 0, 0};           
        Node and2{empty(holder), empty(holder), NodeType::AND, 5, 4, 0, 0};           
        Node not_p{empty(holder), empty(holder), NodeType::NOT, 0, 1, 0, 0};          
        Node since_node{empty(holder), empty(holder), NodeType::SINCE, 7, 0, since_a, since_b}; 
        Node implies_node{empty(holder), empty(holder), NodeType::IMPLIES, 6, 8, 0, 0}; 
        Node always_node{empty(holder), empty(holder), NodeType::ALWAYS, 0, 9, 0, B_INFINITY}; 
...
TEST_CASE("Dense AbsentBR", "[dense][AbsentBR]") {
    ...
    SECTION("AbsentBR " + benchmarkName) {
        ...
        Node r{empty(holder), empty(holder), NodeType::PROPOSITION, 0, 0, 0, 0};      
        Node not_p{empty(holder), empty(holder), NodeType::NOT, 0, 1, 0, 0};          
        Node inner_always{empty(holder), empty(holder), NodeType::ALWAYS, 0, 3, 0, inner_always_b}; 
        Node implies_node{empty(holder), empty(holder), NodeType::IMPLIES, 2, 4, 0, 0}; 
        Node root_always{empty(holder), empty(holder), NodeType::ALWAYS, 0, 5, 0, B_INFINITY}; 
...
TEST_CASE("Dense AlwaysAQ", "[dense][AlwaysAQ]") {
    ...
    SECTION("AlwaysAQ " + benchmarkName) {
        ...
        Node p{empty(holder), empty(holder), NodeType::PROPOSITION, 0, 0, 0, 0};      
        Node r{empty(holder), empty(holder), NodeType::PROPOSITION, 0, 0, 0, 0};      
        Node once_q{empty(holder), empty(holder), NodeType::EVENTUALLY, 0, 0, 0, once_b}; 
        Node since_node{empty(holder), empty(holder), NodeType::SINCE, 1, 0, 0, B_INFINITY}; 
        Node implies_node{empty(holder), empty(holder), NodeType::IMPLIES, 3, 4, 0, 0}; 
        Node root_always{empty(holder), empty(holder), NodeType::ALWAYS, 0, 5, 0, B_INFINITY}; 
...
TEST_CASE("Dense AlwaysBQR", "[dense][AlwaysBQR]") {
    ...
    SECTION("AlwaysBQR " + benchmarkName) {
        ...
        Node and2{empty(holder), empty(holder), NodeType::AND, 5, 4, 0, 0};           
        Node not_p{empty(holder), empty(holder), NodeType::NOT, 0, 1, 0, 0};          
        Node since_node{empty(holder), empty(holder), NodeType::SINCE, 1, 0, since_a, since_b}; 
        Node implies_node{empty(holder), empty(holder), NodeType::IMPLIES, 6, 8, 0, 0}; 
        Node always_node{empty(holder), empty(holder), NodeType::ALWAYS, 0, 9, 0, B_INFINITY}; 
...
TEST_CASE("Dense AlwaysBR", "[dense][AlwaysBR]") {
    ...
    SECTION("AlwaysBR " + benchmarkName) {
        ...
        Node p{empty(holder), empty(holder), NodeType::PROPOSITION, 0, 0, 0, 0};      
        Node r{empty(holder), empty(holder), NodeType::PROPOSITION, 0, 0, 0, 0};      
        Node inner_always{empty(holder), empty(holder), NodeType::ALWAYS, 0, 1, 0, inner_always_b}; 
        Node implies_node{empty(holder), empty(holder), NodeType::IMPLIES, 2, 3, 0, 0}; 
        Node root_always{empty(holder), empty(holder), NodeType::ALWAYS, 0, 4, 0, B_INFINITY}; 
...
TEST_CASE("Dense RecurBQR", "[dense][RecurBQR]") {
    ...
    SECTION("RecurBQR " + benchmarkName) {
        ...
        Node and1{empty(holder), empty(holder), NodeType::AND, 2, 3, 0, 0};           
        Node and2{empty(holder), empty(holder), NodeType::AND, 5, 4, 0, 0};           
        Node p_or_q{empty(holder), empty(holder), NodeType::OR, 1, 0, 0, 0};          
        Node once_p_or_q{empty(holder), empty(holder), NodeType::EVENTUALLY, 0, 7, 0, inner_once_b}; 
        Node since_node{empty(holder), empty(holder), NodeType::SINCE, 8, 0, 0, B_INFINITY}; 
        Node implies_node{empty(holder), empty(holder), NodeType::IMPLIES, 6, 9, 0, 0}; 
        Node root_always{empty(holder), empty(holder), NodeType::ALWAYS, 0, 10, 0, B_INFINITY}; 
...
TEST_CASE("Dense RespondBQR", "[dense][RespondBQR]") {
    ...
    SECTION("RespondBQR " + benchmarkName) {
        ...
        Node q{empty(holder), empty(holder), NodeType::PROPOSITION, 0, 0, 0, 0};      
        Node p{empty(holder), empty(holder), NodeType::PROPOSITION, 0, 0, 0, 0};      
        Node s{empty(holder), empty(holder), NodeType::PROPOSITION, 0, 0, 0, 0};      
        Node r{empty(holder), empty(holder), NodeType::PROPOSITION, 0, 0, 0, 0};      
        Node not_q{empty(holder), empty(holder), NodeType::NOT, 0, 0, 0, 0};          
        Node once_q{empty(holder), empty(holder), NodeType::EVENTUALLY, 0, 0, 0, B_INFINITY}; 
        Node and_A1{empty(holder), empty(holder), NodeType::AND, 3, 4, 0, 0};         
        Node and_A2{empty(holder), empty(holder), NodeType::AND, 6, 5, 0, 0};         
        Node once_p{empty(holder), empty(holder), NodeType::EVENTUALLY, 0, 1, once_a, once_b}; 
        Node implies_D{empty(holder), empty(holder), NodeType::IMPLIES, 2, 8, 0, 0};    
        Node not_s{empty(holder), empty(holder), NodeType::NOT, 0, 2, 0, 0};          
        Node since_F{empty(holder), empty(holder), NodeType::SINCE, 10, 1, since_a, B_INFINITY}; 
        Node not_F{empty(holder), empty(holder), NodeType::NOT, 0, 11, 0, 0};         
        Node and_C{empty(holder), empty(holder), NodeType::AND, 9, 12, 0, 0};         
        Node since_B{empty(holder), empty(holder), NodeType::SINCE, 13, 0, 0, B_INFINITY}; 
        Node implies_main{empty(holder), empty(holder), NodeType::IMPLIES, 7, 14, 0, 0}; 
        Node root_always{empty(holder), empty(holder), NodeType::ALWAYS, 0, 15, 0, B_INFINITY}; 
...
TEST_CASE("Dense RespondGLB", "[dense][RespondGLB]") {
    ...
    SECTION("RespondGLB " + benchmarkName) {
        ...
        Node p{empty(holder), empty(holder), NodeType::PROPOSITION, 0, 0, 0, 0};      
        Node s{empty(holder), empty(holder), NodeType::PROPOSITION, 0, 0, 0, 0};      
        Node once_p{empty(holder), empty(holder), NodeType::EVENTUALLY, 0, 0, once_a, once_b}; 
        Node implies_D{empty(holder), empty(holder), NodeType::IMPLIES, 1, 2, 0, 0};    
        Node not_s{empty(holder), empty(holder), NodeType::NOT, 0, 1, 0, 0};          
        Node since_F{empty(holder), empty(holder), NodeType::SINCE, 4, 0, since_a, B_INFINITY}; 
        Node not_F{empty(holder), empty(holder), NodeType::NOT, 0, 5, 0, 0};         
        Node and_C{empty(holder), empty(holder), NodeType::AND, 3, 6, 0, 0};         
        Node root_always{empty(holder), empty(holder), NodeType::ALWAYS, 0, 7, 0, B_INFINITY}; 
